...
public class Game {
    ...
    private static final Color PURPLE = new Color(146, 82, 229, 255);
    private static final Color PINK = new Color(237, 126, 255, 255);
    private static final Color ORANGE = new Color(255, 172, 107, 255);
    ...
    public void initialize(Point center, int radius, Color color) {
       ...
       //creating score indicator
        ...
        Paddle paddle = new Paddle(new Block(new Point(350, 550), 100, 15, LIGHT_GRAY),
